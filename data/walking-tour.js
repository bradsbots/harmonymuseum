window.WALKING_TOUR = {
 "meta": {
  ...
  "namePolicy": "The `name` field carries the PDF brochure facts-page name only as a working label. Where sources disagree, `nameVariants` holds every spelling and `needsConfirmation` is true. No spelling has been chosen — the museum decides; stop URLs must not be minted from disputed names until then.",
 ...
 "stops": [
  ...
  {
   "number": 7,
   "name": "Post Office (Harmony Public School)",
   "nameVariants": {
  ...
  {
   "number": 13,
   "name": "Beahm Hotel (Site of Harmonite Inn)",
   "nameVariants": {
  ...
  },
  {
   ...
   "era": "undetermined",
   "eraNote": "Early 19th-century structure; the brochure says its early history is undetermined.",
   "inTown": true,
   "needsConfirmation": false,
  ...
  },
  {
   ...
   "era": "undetermined",
   "eraNote": "Log construction, era not stated in either source; relocated from Zelienople in the 1990s. TODO: ask the museum.",
   "inTown": true,
   "needsConfirmation": false,
